...
exports.sendLeaveApplicationEmail = sendLeaveApplicationEmail;
...
async function sendLeaveApplicationEmail(approverEmail, applicantName, leaveType, fromDate, toDate) {
...
async function sendLeaveStatusEmail(applicantEmail, applicantName, status, leaveType) {
    if (!isEmailConfigured) {
