...
router.get('/', (0, authorize_1.authorize)(['Admin', 'Manager', 'HR']), async (req, res) => {
    try {
...
router.post('/:inquiryId/team', (0, authorize_1.authorize)(['Admin', 'Manager']), async (req, res) => {
    try {
        const { inquiryId } = req.params;
...
router.delete('/team/:id', (0, authorize_1.authorize)(['Admin', 'Manager']), async (req, res) => {
    try {
        const { id } = req.params;
